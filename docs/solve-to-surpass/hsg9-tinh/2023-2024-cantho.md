...
**Yêu cầu:** xác định tổng giá trị lớn nhất của $k$ phần quà có thể chọn.
...
**Yêu cầu:** xác định số lượng nhiều nhất các cây liên tục được tưới.
...
**Yêu cầu:** giải mã nội dung bức thư trên.
...
**Yêu cầu:** tìm số lần xuất hiện của giá trị $k$ trong bảng số trên.
