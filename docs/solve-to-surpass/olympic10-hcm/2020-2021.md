...
- $N$ dòng tiếp theo, mỗi dòng ghi hai số nguyên dương $A_i$ và $B_i$ cho biết thời điểm đi vào và thời điểm đi ra của mỗi khách hàng $(0 \lt A_i \lt B_i \lt 10^6)$.
...
Hai chú gấu con đã tìm được trong rừng hai miếng phô mai có khối lượng tương ứng là $a$ và $b$ gram, với $a$ và $b$ là số nguyên. Hai chú gấu tham lam đến nỗi muốn đánh nhau để tranh phần miếng phô mai nhiều hơn.
...
**Yêu cầu:** Bạn hãy tìm số thao tác ít nhất đã mô tả ở trên sao cho cáo có thể chia thành hai miếng phô mai bằng nhau.
...
Sau 3 lần chia, Cáo có 2 miếng bằng nhau là 5g. Vậy kết quả là 3. Không có cách chia nào khác nhanh hơn 3 lần.
