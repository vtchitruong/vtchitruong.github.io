...
??? tip "Hint"
    ...
    1. **View** tab > **New Window**.
        ...
        ![Minh họa hướng dẫn](images/question-02-1.png){loading=lazy}

    2. **View** tab > **Arrange All**.

        ![Minh họa hướng dẫn](images/question-02-2.png){loading=lazy}
...
??? tip "Hint"
    ...
    3. Chọn thư mục **GMetrixTemplates** > gõ tên tập tin **Powerpoint01** (đừng gõ đuôi .pdf)> Bỏ chọn **Open File After Publishing** > **Save**.
        ...
        ![Minh họa hướng dẫn](images/question-03-3.png){loading=lazy}
...
??? tip "Hint"
    ...
    2. **File** tab > **Export** > **Change File Type** > **JPEG File Interchange Format (*.jpg)** > **Save As**.
        ...
        ![Minh họa hướng dẫn](images/question-04-2.png){loading=lazy}
    ...
    4. Khi gặp thông báo "**Which slides do you want to export?**", thì click **Just This One**.
        ...
        ![Minh họa hướng dẫn](images/question-04-4.png){loading=lazy}
...
??? tip "Hint"
    ...
    2. **Shape Format** tab > click mũi tên của **WordArt Styles** > tìm **Fill - Orange, Accent 2, Outline - Accent 2**.
        ...
        ![Minh họa hướng dẫn](images/question-05.png){loading=lazy}
...
??? tip "Hint"
    ...
    ![Minh họa hướng dẫn](images/question-07-1.png){loading=lazy}

    ![Minh họa hướng dẫn](images/question-07-2.png){loading=lazy}

    ![Minh họa hướng dẫn](images/question-07-3.png){loading=lazy}
...
??? tip "Hint"
    ...
    2. Trong hộp thoại **Set Up Show**, chọn mục **Browsed by an individual** > chọn mục **Loop continuously until 'Esc'** > **OK**.
        ...
        ![Minh họa hướng dẫn](images/question-08-2.png){loading=lazy}
...
??? tip "Hint"
    ...
    3. Trong hộp thoại **Define Custom Show**, chọn hai slide 4 và 5 > **Add** > **OK**.
        ...
        ![Minh họa hướng dẫn](images/question-09-3.png){loading=lazy}
...
??? tip "Hint"
    ...
    1. **Review** tab > **Spelling**.
        ...
        ![Minh họa hướng dẫn](images/question-10-1.png){loading=lazy}

    2. Trong bảng **Spelling** bên phải, chọn **Reading** > **Change All**.
        
        ![Minh họa hướng dẫn](images/question-10-2.png){loading=lazy}
