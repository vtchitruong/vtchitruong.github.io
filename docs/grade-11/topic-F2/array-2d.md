...
<div>
    <iframe style="width: 100%; height: 500px" frameBorder=0 src="../mindmaps/array-2d.html">Sơ đồ tóm tắt</iframe>
</div>
...
1. [GitHub](https://github.com/vtchitruong/gdpt-2018/blob/main/grade-11/topic-f2/array-2-dimension-numpy.py){:target="_blank"}
