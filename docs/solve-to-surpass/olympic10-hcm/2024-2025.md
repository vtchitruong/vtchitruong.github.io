...
| --- | --- | --- |
| 4 <br> 6 <br> 2 | 3 | Với quỹ thời gian 4 buổi, An sẽ luyện tập 3 buổi (giảm 3 * 2 = 6 đơn vị) và ngủ sớm 1 buổi (tăng 1 * 6 = 6 đơn vị). <br> Thời khóa biểu này bảo đảm sau 4 buổi tối mức năng lượng không tăng và cũng không giảm. |
| 2 <br> 1 <br> 2 | -1 |
