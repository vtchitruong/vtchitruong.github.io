...
Một số nguyên là số buổi ngày An sẽ luyện tập. Nếu An không thể lập thời khóa biểu theo yêu cầu trên thì ghi $-1$.

**Ví dụ:**

| NANGLUONG.INP	| NANGLUONG.OUT	| Giải thích |
| --- | --- | --- |
| 4 <br> 6 <br> 2 | 3 | Với quỹ thời gian 4 buổi tối, An sẽ luyện tập 3 buổi (giảm 3 * 2 = 6 đơn vị) và ngủ sớm 1 buổi (tăng 1 * 6 = 6 đơn vị). <br> Thời khóa biểu này bảo đảm sau 4 buổi tối mức năng lượng không tăng và cũng không giảm. |
| 2 <br> 1 <br> 2 | -1 |
...
- [GitHub](https://github.com/vtchitruong/hsg/tree/main/olympic10-hcm/2024-2025/nangluong){target="_blank"}
...
??? tip "Ý tưởng chính"
    ...
    - Đặt biến phụ `cumulative` dùng để lưu trữ giá trị tích lũy mà sẽ cộng thêm cho phần tử liền sau `a[i]`: `cumulative += x` và `new_ai = ai + cumulative`.
...
- [GitHub](https://github.com/vtchitruong/hsg/tree/main/olympic10-hcm/2024-2025/boiba){target="_blank"}
...
![Minh họa test case 1](images/2024-2025-latgach-test-1.png){loading=lazy width=240}

![Minh họa test case 2](images/2024-2025-latgach-test-2.png){loading=lazy width=240}
...
- [GitHub](https://github.com/vtchitruong/hsg/tree/main/olympic10-hcm/2024-2025/latgach){target="_blank"}