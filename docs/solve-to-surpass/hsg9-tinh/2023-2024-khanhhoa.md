...
# Học sinh giỏi 9 Khánh Hòa 2023 - 2024
...
Có rất nhiều gạo trong kho, các hạt gạo được đánh số thứ tự là số nguyên liên tiếp từ $a$ đến $b$. Dì ghẻ bắt Lọ Lem phải nhặt ra các hạt gạo có số thứ tự là bội của một số $k$ cho trước. Đồng thời sau khi nhặt xong phải cho biết số lượng hạt gạo nhặt được.
...
| --- | --- | --- |
| 3 10 5 | 2 | Hai hạt gạo được nhặt có số thứ tự là 5 và 10. |
| 6 9 5 | 0 | Không có hạt nào thỏa yêu cầu. |

**Ràng buộc:**

- 70% số test tương ứng với 70% số điểm có $1 \le a \le b < 10^6$.
- 30% số test còn lại tương ứng 30% điểm số không có ràng buộc gì thêm.

### Cách giải đề xuất

??? tip "Ý tưởng chính"

    1\. Các bội của $k$ gồm: $1k, 2k, 3k, \cdots, qk$.

    Các bội của $k$ không vượt quá $n$ nghĩa là $qk \le n$.

    Mà $q$ là các giá trị nằm trong đoạn $[1..q]$.

    Do đó, $q$ là số lượng các bội của $k$ mà không vượt quá $n$.

    2\. Để tính số lượng bội của $k$ trong đoạn $[a..b]$, ta thực hiện như sau:

    - Tính số lượng bội của $k$ trong đoạn $[1..b]$: $\frac{b}{k}$ $(1)$
    - Tính số lượng bội của $k$ trong đoạn $[1..a - 1]$: $\frac{a - 1}{k}$ $(2)$
    - Tính số lượng bội của $k$ trong đoạn $[a..b]$: tính hiệu của $(1)$ và $(2)$.
...
Vốn là người sáng tạo, An đưa ra một khái niệm mới gọi là "số nguyên tố toàn diện". Một số nguyên dương x gọi là số nguyên tố toàn diện nếu thỏa đồng thời 3 điều kiện sau:
...
Viết ba hàm kiểm tra từng điều kiện thỏa số nguyên tố toàn diện.
