...
| Tác vụ | Thiên về các tác vụ: sáng tạo nội dung, chơi game *"nặng"*, phát triển phần mềm. | Thiên về các tác vụ: giao tiếp, giải trí, định hướng, tìm vị trí. |
| Cấu hình phần cứng| Vẫn đáp ứng được nhiều cấu hình khác nhau. Mặt khác, các cấu hình vẫn tương đối nhất quán. | Phải đáp ứng đa dạng các cấu hình, dẫn đến sự phân mảnh lớn hơn. |
| Thiết bị nhập liệu| Thiên về chuột và bàn phím. | Thiên về các thao tác cảm ứng, cử chỉ, giọng nói. |
| Giao diện người dùng| Phù hợp với các loại màn hình lớn, thường trên 13 inch.| Phù hợp với các loại màn hình nhỏ, thường dưới 13 inch. |
| Khả năng đa nhiệm| Chạy được nhiều ứng dụng cùng lúc. | Thường chỉ tập trung vào một ứng dụng tại một thời điểm. |
| Hệ sinh thái phần mềm| Thiên về việc đáp ứng các ứng dụng phức tạp và giàu tính năng.| Thiên về việc đáp ứng các ứng dụng có tác vụ đơn giản và thao tác nhanh chóng. |
| Kết nối mạng| Thiên về kết nối có dây. | Thiên về kết nối không dây: WiFi, dữ liệu di động, Bluetooth, NFC. |
...
3. **Hệ sinh thái ứng dụng**
    ...
    Android có hệ sinh thái ứng dụng khổng lồ, phần lớn được tải từ chợ ứng dụng chính thức là [Google Play](https://play.google.com/store/apps){:target="_blank"}. Ngoài ra, còn có nhiều chợ ứng dụng khác.
...
5. **Khả năng tích hợp đám mây**
    ...
    Thiết bị Android được tích hợp chặt chẽ với các dịch vụ đám mây, cho phép người dùng sao lưu dữ liệu, hình ảnh, ứng dụng của mình và đồng bộ chúng qua các thiết bị khác nhau.
...
7. **Tính năng thông báo**
    ...
    Android cung cấp hệ thống thông báo toàn diện, giúp người dùng luôn được thông báo đúng lúc về các tin nhắn và sự kiện.

8. **Đa dạng thiết bị**

    Android là một nền tảng linh hoạt, có thể chạy trên nhiều loại thiết bị khác nhau.
